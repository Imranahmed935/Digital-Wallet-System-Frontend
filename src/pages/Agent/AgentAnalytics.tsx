...
const AgentAnalytics = () => {
  ...
  return (
    <div id="agent-analytic" className="min-h-screen p-4 sm:p-6 md:p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="bg-white dark:bg-card border-violet-600 shadow-md rounded-xl">
          <CardContent className="flex items-center gap-3 p-4">
            <ArrowDownCircle className="w-6 h-6 text-green-500" />
            <div>
              <p className="text-sm text-gray-500 dark:text-foreground">Cash In</p>
        ...
        <Card className="bg-white shadow-md rounded-xl dark:bg-card border-violet-600">
          <CardContent className="flex items-center gap-3 p-4">
            <ArrowUpCircle className="w-6 h-6 text-red-500" />
            <div>
              <p className="text-sm text-gray-500 dark:text-foreground">Cash Out</p>
              <p className="text-lg font-bold text-gray-800 dark:text-muted-foreground">
        ...
        <Card className="bg-white shadow-md rounded-xl dark:bg-card border-violet-600">
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <div>
              <p className="text-sm text-gray-500 dark:text-foreground">Commission</p>
              <p className="text-lg font-bold text-gray-800 dark:text-muted-foreground">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        <Card className="bg-indigo-50 dark:bg-card border-violet-600 shadow-md rounded-xl cursor-pointer hover:bg-indigo-100 transition">
        ...
        <Card className="bg-indigo-50 dark:bg-card border-violet-600 shadow-md rounded-xl cursor-pointer hover:bg-indigo-100 transition">
          <CardContent className="flex flex-col items-center justify-center p-6">
            ...
            <p className="text-gray-800 font-medium dark:text-foreground">Profile Management</p>
          </CardContent>
        </Card>
      </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="text-gray-500 text-sm border-b border-gray-200">
                <th className="py-2 px-3 dark:text-foreground">Date</th>
                <th className="py-2 px-3 dark:text-foreground">User</th>
                <th className="py-2 px-3 dark:text-foreground">Action</th>
                <th className="py-2 px-3 dark:text-foreground">Amount</th>
                <th className="py-2 px-3 dark:text-foreground">Status</th>
              </tr>
            </thead>
